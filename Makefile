...
OBJ = gameLoop.o player.o weapon.o sprites.o render.o level.o ../genericDynamicList.c physics.o gameMode.o menu.o bar.o audio.o
TARGET = game
...
genericDynamicList.o: genericDynamicList
